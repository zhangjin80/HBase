...
public class ReadHDFSDataToHBaseMR extends Configured implements Tool{
	...
	public int run(String[] arg0) throws Exception {
		...
		//等同于job.setReducerClass(cls);job.setOutputFormatClass(cls);
		//设置TableReducerJob,如果在本地pc测试运行使用本地jar包，就需要把最后一个参数配置成false
		TableMapReduceUtil.initTableReducerJob("student", HBase_Reducer.class, job, null, null, null, null, false);
		//如在集群上跑设置以下参数就可以
		//TableMapReduceUtil.initTableReducerJob("student", HBase_Reduce.class, job);
